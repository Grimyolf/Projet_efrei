...
public class Loan {
	...
	public Loan(int borrower_id, int book_id, int issuer_id, java.util.Date issued_date, int receiver_id,
	...
	public Loan(int id, int borrower_id, int book_id, int issuer_id, java.util.Date issued_date, int receiver_id,
			java.util.Date return_date) {
	...
	public String toString() {
		return "Loan [ID= " + id + ", borrower ID= " + borrower_id + ", book ID= " + book_id + ", issuer ID= "
				+ issuer_id + ", date de retour= " + return_date + "]";
	}
